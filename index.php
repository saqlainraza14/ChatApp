...
namespace Social_Chat;
use Chat_Common;
class Model extends Chat_Common\Model
{
...
class Controller extends Chat_Common\Controller
{
    protected $_model;

    public function __construct()
    {
        $this->setModel('Social_Chat\Model');
        parent::__construct();
    }
...
<head>
    ...
    <title>Simple PHP Chat with Angular JS</title>
